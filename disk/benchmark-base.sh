...
function fio_02 {
    ...
    (
        ...
        exec_for_each_devices fio_md_raw "${benchname}" "${fio_option}" md0 0 $devsize $fiosize 2 ${onboard}
        exec_for_each_devices fio_md_raw "${benchname}" "${fio_option}" md0 1 $devsize $fiosize 2 ${onboard}
        exec_for_each_devices fio_md_raw "${benchname}" "${fio_option}" md0 5 $devsize $fiosize 3 ${onboard}
        exec_for_each_devices fio_md_raw "${benchname}" "${fio_option}" md0 6 $devsize $fiosize 4 ${onboard}

        exec_for_each_devices fio_md_ext4 "${benchname}" "${fio_option}" md0 0 $devsize $fiosize 2 ${onboard}
        exec_for_each_devices fio_md_ext4 "${benchname}" "${fio_option}" md0 1 $devsize $fiosize 2 ${onboard}
        exec_for_each_devices fio_md_ext4 "${benchname}" "${fio_option}" md0 5 $devsize $fiosize 3 ${onboard}
...
function fio_03 {
    ...
    (
        ...
        exec_for_each_devices fio_md_raw "${benchname}" "${fio_option}" md0 0 $devsize $fiosize 2 ${sas3008}
        exec_for_each_devices fio_md_raw "${benchname}" "${fio_option}" md0 1 $devsize $fiosize 2 ${sas3008}
        exec_for_each_devices fio_md_raw "${benchname}" "${fio_option}" md0 5 $devsize $fiosize 3 ${sas3008}
        exec_for_each_devices fio_md_raw "${benchname}" "${fio_option}" md0 6 $devsize $fiosize 4 ${sas3008}

        exec_for_each_devices fio_md_ext4 "${benchname}" "${fio_option}" md0 0 $devsize $fiosize 2 ${sas3008}
        exec_for_each_devices fio_md_ext4 "${benchname}" "${fio_option}" md0 1 $devsize $fiosize 2 ${sas3008}
        exec_for_each_devices fio_md_ext4 "${benchname}" "${fio_option}" md0 5 $devsize $fiosize 3 ${sas3008}
        exec_for_each_devices fio_md_ext4 "${benchname}" "${fio_option}" md0 6 $devsize $fiosize 4 ${sas3008}
    )
}
...
function fio_05 {
    ...
    (
        ...
        exec_for_each_devices fio_zfs_simple "${benchname}" "${fio_option}" zfspool stripe $devsize $fiosize 2 ${onboard}
        exec_for_each_devices fio_zfs_simple "${benchname}" "${fio_option}" zfspool mirror $devsize $fiosize 2 ${onboard}
        exec_for_each_devices fio_zfs_simple "${benchname}" "${fio_option}" zfspool raidz $devsize $fiosize 3 ${onboard}
...
function fio_06 {
    ...
    (
        ...
        exec_for_each_devices fio_zfs_simple "${benchname}" "${fio_option}" zfspool stripe $devsize $fiosize 2 ${sas3008}
        exec_for_each_devices fio_zfs_simple "${benchname}" "${fio_option}" zfspool mirror $devsize $fiosize 2 ${sas3008}
        exec_for_each_devices fio_zfs_simple "${benchname}" "${fio_option}" zfspool raidz $devsize $fiosize 3 ${sas3008}
        exec_for_each_devices fio_zfs_simple "${benchname}" "${fio_option}" zfspool raidz2 $devsize $fiosize 4 ${sas3008}
    )
}
